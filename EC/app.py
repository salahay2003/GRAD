...
from color_palette import preprocess_image, apply_mask, generate_extension_color_2, U2NET_MODEL
...
def process_image():
    try:
        ...
        all_palettes = generate_extension_color_2(focal_object, n_colors=3)
...
def process_prompt():
    ...
    print(input_string, 'Inputstring recived')
